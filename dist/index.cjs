...
__export(src_exports, {
  ...
  assertPageDocument: () => assertPageDocument,
  cloneNode: () => cloneNode,
...
function PageRenderer({ document, renderUnknown }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: document.root.map((n) => renderTree(n, renderUnknown)) });
}
function renderTree(node, renderUnknown) {
  const def = getBlock(node.type);
  if (!def) {
    return renderUnknown ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.default.Fragment, { children: renderUnknown(node) }, node.id) : null;
  }
  const children = node.children?.map((c) => renderTree(c, renderUnknown));
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.default.Fragment, { children: def.render({ node, children, isEditing: false }) }, node.id);
}
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
        "div",
        {
          ...
          children: [
            children,
            isEditing && isEmpty ? Array.from({ length: columnCount }, (_, index) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
              "div",
              {
                "aria-hidden": "true",
                style: {
...
var Button = {
  ...
  render: ({ node, isEditing }) => {
    const p = node.props;
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { ...spacingStyle(p), textAlign: p.align }, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      "a",
      {
...
var Spacer = {
  ...
  render: ({ node, isEditing }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    "div",
    {
      style: {
        ...spacingStyle(node.props),
...
var Embed = {
  ...
  render: ({ node }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { ...spacingStyle(node.props) }, dangerouslySetInnerHTML: { __html: node.props.html || "" } })
};
var coreBlocks = [
  Section,
  Columns,
