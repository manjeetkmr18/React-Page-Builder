...
function PageBuilder({
  ...
  if (loading) {
    return /* @__PURE__ */ jsxs2("div", { className: "rpb-root rpb-loading", style: { height }, children: [
      /* @__PURE__ */ jsx2("style", { dangerouslySetInnerHTML: { __html: EDITOR_CSS } }),
      /* @__PURE__ */ jsx2("div", { className: "rpb-loading-message", children: "Loading page..." })
    ] });
  }
  return /* @__PURE__ */ jsxs2("div", { className: "rpb-root", style: { height }, children: [
    /* @__PURE__ */ jsx2("style", { dangerouslySetInnerHTML: { __html: EDITOR_CSS } }),
    /* @__PURE__ */ jsxs2("div", { className: "rpb-toolbar", children: [
      /* @__PURE__ */ jsx2("span", { className: "rpb-brand", children: "Page Builder" }),
      /* @__PURE__ */ jsxs2("div", { className: "rpb-toolbar-group", children: [
        /* @__PURE__ */ jsx2("button", { className: "rpb-btn", onClick: undo, title: "Undo (Ctrl+Z)", children: "Undo" }),
        /* @__PURE__ */ jsx2("button", { className: "rpb-btn", onClick: redo, title: "Redo (Ctrl+Y)", children: "Redo" })
      ] }),
      /* @__PURE__ */ jsxs2("div", { className: "rpb-toolbar-group", children: [
        /* @__PURE__ */ jsx2("button", { className: "rpb-btn", onClick: () => fileInput.current?.click(), children: "Import JSON" }),
        /* @__PURE__ */ jsx2("button", { className: "rpb-btn", onClick: exportJson, children: "Export JSON" }),
        /* @__PURE__ */ jsx2(
          "input",
          {
            ref: fileInput,
      ...
      /* @__PURE__ */ jsx2("div", { className: "rpb-toolbar-spacer" }),
      /* @__PURE__ */ jsx2(
        "button",
        {
      ...
      canSave && saveState !== "idle" && /* @__PURE__ */ jsx2("span", { className: "rpb-save-status rpb-save-status-" + saveState, children: saveMessage ?? (saveState === "saved" ? "Saved" : saveState) })
    ] }),
    /* @__PURE__ */ jsxs2("div", { className: "rpb-body", children: [
      !previewing && /* @__PURE__ */ jsx2("aside", { className: "rpb-palette", children: /* @__PURE__ */ jsx2(Palette, { onDragChange: setDragging }) }),
      /* @__PURE__ */ jsx2(
        "main",
        {
          ...
          children: /* @__PURE__ */ jsx2(
            "div",
            {
              ...
              children: previewing ? /* @__PURE__ */ jsx2(RenderPlain, { nodes: doc.root }) : /* @__PURE__ */ jsxs2(Fragment, { children: [
                /* @__PURE__ */ jsx2(
                  NodeList,
                  {
                    nodes: doc.root,
                ...
                doc.root.length === 0 && /* @__PURE__ */ jsxs2("div", { className: "rpb-empty", children: [
                  "Drag a ",
                  /* @__PURE__ */ jsx2("strong", { children: "Section" }),
      ...
      !previewing && /* @__PURE__ */ jsx2("aside", { className: "rpb-inspector", children: selected && selectedDef ? /* @__PURE__ */ jsx2(
        Inspector,
        {
          node: selected,
          def: selectedDef,
      ...
      ) : /* @__PURE__ */ jsx2("div", { className: "rpb-inspector-empty", children: "Select a block on the canvas to edit its settings" }) })
    ] })
  ] });
}
function Palette({ onDragChange }) {
  ...
  return /* @__PURE__ */ jsxs2(Fragment, { children: [
    /* @__PURE__ */ jsx2("div", { className: "rpb-panel-title", children: "Blocks" }),
    Object.entries(grouped).map(([cat, defs]) => /* @__PURE__ */ jsxs2("div", { children: [
      /* @__PURE__ */ jsx2("div", { className: "rpb-category", children: cat }),
      /* @__PURE__ */ jsx2("div", { className: "rpb-palette-grid", children: defs.map((def) => /* @__PURE__ */ jsxs2(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsx2("span", { className: "rpb-palette-icon", children: def.icon ?? "[]" }),
            /* @__PURE__ */ jsx2("span", { children: def.label })
          ]
        },
        def.type
      )) })
...
function NodeList(props) {
  ...
  return /* @__PURE__ */ jsxs2(Fragment, { children: [
    /* @__PURE__ */ jsx2(DropZone, { target: { parentId, index: 0 }, onDrop, visible: dragging }),
    nodes.map((node, i) => /* @__PURE__ */ jsxs2(React2.Fragment, { children: [
      /* @__PURE__ */ jsx2(NodeFrame, { ...props, node }),
      /* @__PURE__ */ jsx2(
        DropZone,
        {
...
function NodeFrame(props) {
  ...
  if (!def) {
    return /* @__PURE__ */ jsxs2("div", { className: "rpb-unknown", children: [
      "Unknown block: ",
      node.type
    ] });
  }
  const isSelected = selectedId === node.id;
  const children = def.isContainer ? /* @__PURE__ */ jsx2(NodeList, { ...props, nodes: node.children ?? [], parentId: node.id }) : void 0;
  return /* @__PURE__ */ jsxs2(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx2("span", { className: "rpb-node-label", children: def.label }),
        def.render({ node, children, isEditing: true }),
        def.isContainer && def.showEmptyContainerHint !== false && (node.children ?? []).length === 0 && !dragging && /* @__PURE__ */ jsx2("div", { className: "rpb-container-hint", children: "Drop blocks here" })
      ]
    }
  );
}
function DropZone({
  ...
  if (!visible) return /* @__PURE__ */ jsx2("div", { className: "rpb-dropzone-collapsed" });
...
function RenderPlain({ nodes }) {
  return /* @__PURE__ */ jsx2(Fragment, { children: nodes.map((n) => {
    const def = getBlock(n.type);
    if (!def) return null;
    const children = n.children ? /* @__PURE__ */ jsx2(RenderPlain, { nodes: n.children }) : void 0;
    return /* @__PURE__ */ jsx2(React2.Fragment, { children: def.render({ node: n, children, isEditing: false }) }, n.id);
  }) });
}
function Inspector({
  node,
  ...
  return /* @__PURE__ */ jsxs2(Fragment, { children: [
    /* @__PURE__ */ jsxs2("div", { className: "rpb-panel-title", children: [
      def.icon ? /* @__PURE__ */ jsxs2("span", { children: [
        def.icon,
        " "
      ] }) : null,
      def.label
    ] }),
    /* @__PURE__ */ jsxs2("div", { className: "rpb-inspector-actions", children: [
      /* @__PURE__ */ jsx2("button", { className: "rpb-btn", onClick: onDuplicate, children: "Duplicate" }),
      /* @__PURE__ */ jsx2("button", { className: "rpb-btn rpb-btn-danger", onClick: onDelete, children: "Delete" })
    ] }),
    (def.fields ?? []).map((field) => /* @__PURE__ */ jsxs2("div", { className: "rpb-field", children: [
      /* @__PURE__ */ jsx2("label", { className: "rpb-field-label", children: field.label }),
      /* @__PURE__ */ jsx2(
        Field,
        {
          field,
      ...
      field.helperText && /* @__PURE__ */ jsx2("div", { className: "rpb-field-help", children: field.helperText })
    ] }, field.name)),
    (def.fields ?? []).length === 0 && /* @__PURE__ */ jsx2("div", { className: "rpb-inspector-empty", children: "This block has no settings" })
  ] });
}
